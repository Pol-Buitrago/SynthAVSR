...
color_V = '#90EE90';  % Green color for 'V' data
...
filtered_data_V_lenpen_02 = data_V(data_V(:,2) == 0.5 & data_V(:,1) >= 1, :);
...
title('WER vs Beam Size for Length Penalty = 0.5 | Video Modality', 'FontSize', 24, 'FontWeight', 'bold');
...
legend([h2, h1], {'Length Penalty = 0.5', 'Suboptimal Performance'}, 'Location', 'northwest', 'FontSize', 18);
...
saveas(gcf, 'wer_curve_V_lenpen_05_with_diff.png');
