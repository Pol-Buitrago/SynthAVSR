...
def finetune_avhubert(
    ...
    data_dir=f"{BASE_DIR}/data/Manifests/MixCorpus/data/model_data",
    label_dir=f"{BASE_DIR}/data/Manifests/MixCorpus/data/model_data",
    tokenizer_model=f"{BASE_DIR}/data/Manifests/MixCorpus/data/spm1000/spm_unigram1000.model",
    ...
    run_dir = f"{BASE_DIR}/experiment/finetune/V/MixCorpus/base_vox/{timestamp}"
