...
def finetune_avhubert(
    ...
    data_dir=f"{BASE_DIR}/data/Manifests/CAT/SynthAV-CAT/data/model_data",
    label_dir=f"{BASE_DIR}/data/Manifests/CAT/SynthAV-CAT/data/model_data",
    tokenizer_model=f"{BASE_DIR}/data/Manifests/CAT/SynthAV-CAT/data/spm1000/spm_unigram1000.model",
    ...
    run_dir = f"{BASE_DIR}/experiment/finetune/A/SynthAV-CAT/base_vox/{timestamp}"
