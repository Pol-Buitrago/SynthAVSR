...
def finetune_avhubert(
    ...
    data_dir=f"{BASE_DIR}/data/Manifests/LIP-RTVE/data/model_data",
    label_dir=f"{BASE_DIR}/data/Manifests/LIP-RTVE/data/model_data",
    tokenizer_model=f"{BASE_DIR}/data/Manifests/LIP-RTVE/data/spm1000/spm_unigram1000.model",
    ...
    run_dir = f"{BASE_DIR}/experiment/finetune/A/LIP-RTVE/base_vox/{timestamp}"
