...
def finetune_avhubert(
    ...
    data_dir=f"{BASE_DIR}/data/Manifests/19hours/data/model_data",
    label_dir=f"{BASE_DIR}/data/Manifests/19hours/data/model_data",
    tokenizer_model=f"{BASE_DIR}/data/Manifests/19hours/data/spm1000/spm_unigram1000.model",
    ...
    run_dir = f"{BASE_DIR}/experiment/finetune/A/19hours/base_vox/{timestamp}"
