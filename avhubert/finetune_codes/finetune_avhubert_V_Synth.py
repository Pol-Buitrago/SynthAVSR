...
def finetune_avhubert(
    ...
    data_dir=f"{BASE_DIR}/data/Manifests/SynthAV-CV/data/model_data",
    label_dir=f"{BASE_DIR}/data/Manifests/SynthAV-CV/data/model_data",
    tokenizer_model=f"{BASE_DIR}/data/Manifests/SynthAV-CV/data/spm1000/spm_unigram1000.model",
    checkpoint_path=f"{BASE_DIR}/avhubert/checkpoints/Pretrained_Models/large_vox_iter5.pt",
    #restore_checkpoint=f"{BASE_DIR}/experiment/finetune/V/MixCorpus/base_vox/20241221_025514/checkpoints/checkpoint_best.pt",
):
    """
    ...
    run_dir = f"{BASE_DIR}/experiment/finetune/V/SynthAV-CV/base_vox/{timestamp}"
