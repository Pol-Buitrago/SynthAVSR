...
def finetune_avhubert(
    ...
    config_name="base_vox_433h_A.yaml",
    data_dir=f"{BASE_DIR}/data/Manifests/CAT/SynthAV-CAT_gan/data/model_data",
    label_dir=f"{BASE_DIR}/data/Manifests/CAT/SynthAV-CAT_gan/data/model_data",
    tokenizer_model=f"{BASE_DIR}/data/Manifests/CAT/SynthAV-CAT_gan/data/spm1000/spm_unigram1000.model",
    ...
    run_dir = f"{BASE_DIR}/experiment/finetune/A/SynthAV-CAT_gan/base_vox/{timestamp}"
