...
def finetune_avhubert(
    ...
    data_dir=f"{BASE_DIR}/data/Manifests/05LIP-RTVE/data/model_data",
    label_dir=f"{BASE_DIR}/data/Manifests/05LIP-RTVE/data/model_data",
    tokenizer_model=f"{BASE_DIR}/data/Manifests/05LIP-RTVE/data/spm1000/spm_unigram1000.model",
    ...
    run_dir = f"{BASE_DIR}/experiment/finetune/A/4hours/base_vox/{timestamp}"
