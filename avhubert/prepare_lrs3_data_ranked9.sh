...
N_SHARD=20       # Número de shards (partes en que dividimos los datos para procesamiento)
RANK=19          # Índice de shard a procesar (0 si solo usas un shard)
