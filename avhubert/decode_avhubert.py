...
# Rutas de acceso configuradas para el entorno de Pol
...
DATASET_DIR = "/gpfs/projects/bsc88/speech/research/repos/av_hubert/avhubert/data/datasets/dataset_EN/lrs3"
...
# Comando para ejecutar el script de inferencia con AV-HuBERT
cmd = (
